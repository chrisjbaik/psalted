...
class CreateSchema extends Migration
{
    ...
    {
        $statements = array(
            "CREATE TABLE IF NOT EXISTS song (id INTEGER NOT NULL,  url TEXT,  title TEXT NOT NULL,  chords TEXT,  lyrics TEXT,  artist TEXT,  key INTEGER,  copyright TEXT,  spotify_id TEXT,  PRIMARY KEY (id),  UNIQUE (url))",
            ...
            "CREATE TABLE IF NOT EXISTS setlist_song (  setlist_id INTEGER NOT NULL,  song_id INTEGER NOT NULL,  key INTEGER, chosen_by INTEGER NOT NULL, priority INTEGER NOT NULL, PRIMARY KEY (setlist_id, song_id));"
        );
