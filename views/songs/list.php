...
<div data-role="content">
  <ul data-role="listview" data-divider-theme="a" data-inset="true">
    ...
    <li data-theme="a" data-icon="plus"><a href="/songs/new">New Song</a></li>
    <?php
      if (count($songs) == 0) {
        echo "<li>There are currently no songs.</li>";
      }
      foreach ($songs as $song) {
        echo "<li data-theme='c' class='listview-checkbox'>";
        echo "<a href='#'>";
        echo "<label><input type='checkbox' name='checked_songs[]' value='$song->id' />";
        echo $song->title;
        echo "</label>";
        echo "</a>";
