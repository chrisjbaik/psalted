...
<div data-role="content">
  <ul data-role="listview" data-divider-theme="a" data-inset="true">
    ...
    <li data-theme="c" data-icon="plus"><a href="/groups/<?php echo $group->url; ?>/new">New Setlist</a></li>
    <?php
      if (count($setlists) == 0) {
  ...
  <div data-role="popup" id="group-delete-popup" data-overlay-theme="a" data-theme="a" data-dismissible="false" class="ui-corner-all">
